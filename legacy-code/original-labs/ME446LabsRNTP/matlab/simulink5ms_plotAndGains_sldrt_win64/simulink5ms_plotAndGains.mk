...
MAKECMD         = "C:/MATLAB~4/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MATLAB_ROOT          := C:/MATLAB~4
MATLAB_BIN           := C:/MATLAB~4/bin
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
SLDRTDIR             := C:/MATLAB~4/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
# additional includes
REQ_INCLUDES += ;C:/rohanbn2_thomasp6/ME446_repo/workspace/ME446LabsRNTP/matlab;C:/rohanbn2_thomasp6/ME446_repo/workspace/ME446LabsRNTP/matlab/simulink5ms_plotAndGains_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
