...
void simulink5ms_plotAndGains_output(void)
{
  ...
  /* Gain: '<Root>/plot1' */
  simulink5ms_plotAndGains_B.plot1 = simulink5ms_plotAndGains_P.plot1_Gain *
  ...
  /* Gain: '<Root>/plot2' */
  simulink5ms_plotAndGains_B.plot2 = simulink5ms_plotAndGains_P.plot2_Gain *
  ...
  /* Gain: '<Root>/plot3' */
  simulink5ms_plotAndGains_B.plot3 = simulink5ms_plotAndGains_P.plot3_Gain *
  ...
  {
    {
      ...
      sendToAsyncQueueTgtAppSvc(3195170522U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(3266408048U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(83756041U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(3460972730U, time, pData, size);
    }
  }
...
void simulink5ms_plotAndGains_update(void)
{
  ...
  /* S-Function Block: <S2>/Packet Output */
  {
    ...
    {
      *outdp.p_int16_T++ = simulink5ms_plotAndGains_B.Gain3_j;
    }

    {
      *outdp.p_int16_T++ = simulink5ms_plotAndGains_B.Gain1_i;
    }

    {
      *outdp.p_int16_T++ = simulink5ms_plotAndGains_B.Gain2_d;
    }
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  rtmSetTFinal(simulink5ms_plotAndGains_M, 200.0);
  simulink5ms_plotAndGains_M->Timing.stepSize0 = 0.005;

  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (3011524414U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (1707111838U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (3641541995U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (2656118311U);
  ...
  simulink5ms_plotAndGains_M->Sizes.numBlockIO = (16);/* Number of block outputs */
